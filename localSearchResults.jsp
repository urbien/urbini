  ...
  <td valign="top" align="middle" width="100%">
    ...
    <tr valign="top"><td valign="top">
      <img src="icons/icon.gif" width="16" height="16" align="middle"/>
        ...
        <img src="icons/icon_divider.gif" align="middle" border="0"></img>
      <A title="Search"    href="javascript://" onClick="menuOpenClose('textdiv1', 'menulink_search')"><IMG id="menulink_search" src="images/search.gif"  width="16" height="16" align="middle" border="0"/></A>
      <A title="Filter"    href="javascript://" onClick="menuOpenClose('textdiv2', 'menulink_filter')"><IMG id="menulink_filter" src="images/filter.gif"  width="16" height="16" align="middle" border="0"/></A>
      <A title="Email"     href="javascript://" onClick="menuOpenClose('textdiv3', 'menulink_email')"><IMG id="menulink_email" src="images/email.gif"  width="16" height="16" align="middle" border="0"/></A>
      <A title="Schedule"  href="javascript://" onClick="menuOpenClose('textdiv4', 'menulink_schedule')"><IMG id="menulink_schedule" src="images/calendar.gif"  width="16" height="16" align="middle" border="0"/></A>
      <A title="Languages"  href="javascript://" onClick="menuOpenClose('menudiv_language', 'menulink_language')"><IMG id="menulink_language" src="images/globus.gif" align="middle" border="0"/></A>
      <img src="icons/icon_divider.gif" align="middle" border="0"></img>
