...
<script language="JavaScript">
  ...
  function openChatWindow(url, target) {
    if (window.screen) {
    ...
    window.open(url,target,'width='+w+',height='+h+',top='+ch+',left='+cw+', menubar=no, status=no, location=no, toolbar=no, scrollbars=no, resizable=yes');
  }
</script>
          <a href="javascript://" title="Chat Room" onclick="openChatWindow('http://127.0.0.1/volga/chatRoom?room=test', 'chat');"><img src="chat/chat.jpg" alt="chat" border="0" align="middle" width="20"/></a>
        </td>
