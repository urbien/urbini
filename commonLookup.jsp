      ...
      <table cellspacing="2" cellpadding="5" border="0">
        <tbody>
          <tr>
            ...
            <td align="right" pda="T"><a title="Close" href="javascript://" onClick="menuOpenClose('textdiv1')"><IMG alt="Click here to close" src="images/button_popup_close.gif" border="0"/></a></td>
          </tr>
          <tr>
            <td>
