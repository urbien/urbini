	  ...
	  if(frame.allRTEs){
	    ...
	    for (var i = 0; i < vRTEs.length; i++) {//vRTEs[i]
		  ...
		  if(!document.all){
			...
			oRTE.addEventListener('keyup', function() {if(document.getElementById(rte).contentWindow.document.body.offsetHeight >= 330) document.getElementById(rte).style.height = 330; else document.getElementById(rte).style.height = document.getElementById(rte).contentWindow.document.body.offsetHeight+10; },false);
