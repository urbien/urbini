var server = "http://urbien.com";
var nabit = server + "/nabit";
        ...
        if (location.href.match(i)) 
          ...
          var m = function () {
            ...
            if (m.length == 0) {
                ...
                t_img = new Image;
                t_img.src = server + "/images/urbienLogoBig.png";
                t_img.width = "180";
                f.appendChild(t_img);
...
//                        var c = document.createElement("button");
                        ...
                        c.src = server + "/images/nabit/NabThis.png";
                        ...
                        if (m[h].type == "video") {
                            ...
                            d.src = server + "/images/nabit/VideoIndicator.png";
                            b.appendChild(d)
                        }
                    })(m[h])
                }
