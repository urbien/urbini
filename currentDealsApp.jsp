...
// 		print current deals. Click on any coupon image to view large image and title
      getCurrentDeals("printDeals");
      
//		calls		   http://www.obval.com/api/v1/Coupon?where=dateExpired%3E%3Dtoday,featured!=null&select=featured
      function getCurrentDeals(callbackName) {
        var queryParams = ['where=dateExpired%3E%3Dtoday,featured!=null,basedOnTemplate=null', 'select=featured'];  // 'featured' is the name of the image property        
