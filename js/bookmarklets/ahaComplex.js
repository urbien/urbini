var scripts = document.getElementsByTagName('script'),
    ...
    ahaIdx = ahaScriptSrc.indexOf("/aha.js"),
    ahaServer = ahaScriptSrc.slice(0, ahaIdx),
    ahaAha = ahaServer + "/aha?";
...
//        a.push("?");
    ...
    if (location.href.match(i)) 
    ...
    else if (location.href.indexOf(ahaServer) != -1 && (location.href.indexOf("v/Nab/") != -1 || location.href.indexOf("/www.hudsonfog.com/voc/model/social/Aha") != -1)) {
      window.open(ahaAha + "&sourceUrl=" + location.href, "Nab" + (new Date).getTime(), "status=no,resizable=no,scrollbars=yes,personalbar=no,directories=no,location=no,toolbar=no,menubar=no,width=750,height=450,left=0,top=0");
      return;
    }
    else {
      var w = ahaAha,
      ...
      var m = function () {
        ...
        t_img = new Image;
        t_img.src = ahaServer + "/images/urbienLogoBig.png";
        t_img.width = "180";
        f.appendChild(t_img);
...
//                          var c = document.createElement("button");
                ...
                c.src = ahaServer + "/images/aha.png";
                c.setAttribute("alt", "Aha!");
                c.innerHTML = "Aha!";
                if (isIE()) {
                ...
                if (m[h].type == "video") {
                    ...
                    d.src = ahaServer + "/images/VideoIndicator.png";
                    b.appendChild(d)
                }
            })(m[h])
        }
