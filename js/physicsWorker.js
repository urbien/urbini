...
//      						'../../src/bodies/convex-polygon.js');
	  importScripts('lib/physicsjs-custom.js');
...
//        favor = this.minSlidingWindowDimension * 0.25 * (scrollingTowardsHead ? -1 : 1),
        maxPrepend = range.from,
        maxAppend = Math.max(this.brickLimit - range.to, 0),
//        defaultDelta = this.averageBricksPerNonScrollDim | 0,
        defaultDelta = this.bricksPerPage / 2 | 0,
        headDiff,
        tailDiff;
...
//    }
    ...
    if (viewport.max < slidingWindow.min) { 
