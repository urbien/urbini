...
(function(window) {
    ...
    if (isFirefox) {      
        ...
        attachMediaStream = function(element, stream) {
            ...
            element.src = stream instanceof MediaStream ? webkitURL.createObjectURL(stream) : stream;
        };
...
//        }
    ...
    WebRTC.prototype.getLocalVideoContainer = function() {
        ...
        if (el && el.tagName === 'VIDEO') {
            ...
            this.on('userid', function(userid) {
              media.id = userid;
            });
    ...
    WebRTC.prototype._emit = function(type, msg) {
    ...
    ///////////////////////////////////////// Copyright <A9> 2013 [Muaz Khan](https://github.com/muaz-khan)<[@muazkh](http://twitter.com/muazkh)>. /////////////////////
