  ...
  n.Mixin = {}, n.Mixin.Events = {
    ...
    _initIcon: function() {
      var e = this.options,
          ...
          s = !1;
      this._icon || (this._icon = e.icon.createIcon(), e.title, this._initInteraction(), s = this.options.opacity < 1, n.DomUtil.addClass(this._icon, i)), this._shadow || (this._shadow = e.icon.createShadow(), this._shadow && (n.DomUtil.addClass(this._shadow, i), s = this.options.opacity < 1)), s && this._updateOpacity();
