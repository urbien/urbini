define('lib/gauge', function() {
  ...
  formatNumber = function(num, prefix, suffix) {
    return (prefix || '') + addCommas(num.toFixed(0)) + (suffix || '');
  };
  ...
  ValueUpdater = (function() {
    ...
    ValueUpdater.prototype.update = function(force) {
      ...
      if (force || this.displayedValue !== this.value) {
        ...
        if (this.animationSpeed == Infinity || Math.abs(diff / this.animationSpeed) <= 0.001) {
  ...
  TextRenderer = (function() {
    ...
    TextRenderer.prototype.render = function(gauge) {
      return this.el.innerHTML = formatNumber(gauge.displayedValue, gauge.options.textPrefix, gauge.options.textSuffix);
    };
