{
  ...
  post: {
    js: ['lib/jquery.validate', 'views/ResourceMasonryItemView', 'views/CommentListItemView', 'views/MenuPage', 'views/EditPage', 'views/EditView', 'views/MapView', 'lib/leaflet', 'lib/leaflet.markercluster', 'maps'],
