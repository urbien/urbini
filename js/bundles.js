{
  ...
  post: {
    js: ['views/MenuPanel', 'views/MapView', 'views/PublishButton', 'lib/leaflet', 'lib/leaflet.markercluster', 'maps', 'lib/mobiscroll-datetime-min', 'mobiscroll-duration'],
