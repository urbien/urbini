{
  pre: {
    js: ['lib/jquery', 'jqm-config', 'lib/jquery.mobile-1.3.0-beta.1', 'lib/underscore', 'lib/backbone', 'lib/IndexedDBShim', 'lib/jquery-indexeddb', 'lib/queryIndexedDB', 'lib/jquery.masonry', 'lib/jquery.imagesloaded', 'templates', 'utils', 'error', 'events', 'models/Resource', 'collections/ResourceList', 
     ...
     'views/ResourceListItemView', 'views/ResourceListView', 'views/ResourceMasonryItemView', 'views/CommentListItemView', 'views/ListPage', 'views/ViewPage',  'views/MenuPanel', 'vocManager', 'resourceManager', 'router', 'app'],
  ...
  post: {
    js: ['views/EditPage', 'views/EditView', 'views/MapView', 'lib/leaflet', 'lib/leaflet.markercluster', 'maps', 'lib/mobiscroll-datetime-min', 'mobiscroll-duration'],
