 ...
 */
var identifier = new Date().getTime(); // hack - must be persistent between invocations of this widget
/**
 ...
 */
function setPreferenceForKey(preference, key) {
 ...
 */
function setCloseBoxOffset(x, y) {
  return;
}
 ...
 */
function system(command, endHandler) {
  return;
}