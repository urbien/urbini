<div>
  ...
  <div id="system_tooltip" class="box" style="height:auto !important; height:1px; width:220px; padding: 3px; visibility:hidden; position:absolute; background-color:#fffedc; font-size:12px; z-index:10000; top:0px; left:-400px;">
	<div id="content"></div>
  	<div id="shift_pref" style="font-size:10px; cursor:pointer; color:blue" onclick="javascript: shiftPrefSwitch();">show tooltips when shift pressed</div>
  </div>
