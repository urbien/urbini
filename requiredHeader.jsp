<div>
  ...
  <div id="system_tooltip" class="box" style="width:220px; padding: 3px; visibility:hidden; position:absolute; background-color:#fffedc; font-size:12px; z-index:10000; top:0px; left:-400px;">
    <div id="content"></div>
