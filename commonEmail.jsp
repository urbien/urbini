      ...
      <tr>
        <td>
          <table border="0" cellspacing="2" cellpadding="3">
            <tr><td bgcolor="#DCDCEB"><b>Subject:</b></td><td bgcolor="#DCDCEB"><input name="subject"></input></td></tr>
            <tr><td bgcolor="#DCDCEB"><b>E-mail:</b></td><td bgcolor="#DCDCEB"><input name="to"></input></td></tr>
          </table>
        </td>
      </tr>
