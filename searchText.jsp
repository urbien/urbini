...
<form name="searchForm" method="GET" action="searchResult.html" style="margin-bottom:0; margin-top:0; vertical-align: middle">
 <nobr>
   ...
   <input type="text" class="input" size="12" name="q" value="Search --" onClick="onFormFieldClick(searchForm, this)" onChange="onFormFieldChange(searchForm, this, '-- Search --')" onBlur="onFormFieldChange(searchForm, this, '-- Search --')"/>
