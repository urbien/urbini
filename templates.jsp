...
<script type="text/template" id="cpTemplate">
   <li><a href="{{= Globals.pageRoot + '#' + encodeURIComponent(_uri) + '/' + propName }}">{{= name }}<span class="ui-li-count">{{= value }}</span></a><a href="#" data-icon="plus"></a></li>
</script>

<script type="text/template" id="cpTemplateNoAddNoValue">
   <li><a href="{{= Globals.pageRoot + '#' + encodeURIComponent(_uri) + '/' + propName }}">{{= name }}<span class="ui-li-count">{{= value }}</span></a><a target="#" data-theme="c" data-icon="blank"></a></li>
</script>

<script type="text/template" id="cpTemplateNoAdd">
   <li><a href="{{= Globals.pageRoot + '#' + encodeURIComponent(_uri) + '/' + propName }}">{{= name }}<span class="ui-li-count">{{= value }}</span></a><a target="#" data-theme="c" data-icon="arrow-r"></a></li>
</script>
