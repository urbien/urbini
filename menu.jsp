...
<table width="100%" cellspacing="0" cellpadding="0" border="0" id="mainMenu" class="toppad">
  <tr align="center">
    ...
    <td align="right">
       ...
       <a id="menuLink_codeBehindThePage" title="View Source - this page is based solely on the declarative code that you can inspect by clicking on the links in popup">
